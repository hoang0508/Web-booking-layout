...
const CountHotel = ({ className }: ICountHotel) => {
  ...
  const [inputCountRoom, setInputCountRoom] = useState(1);
  const [inputCountAdult, setinputCountAdult] = useState(1);
  const [inputCountChildren, setInputCountChildren] = useState(0);
          ...
          label: (
            <>
              <div className="flex items-center justify-between mb-3 py-0 px-4">
                ...
                <div>
                  <CountInput
                    inputCount={inputCountRoom}
                    setInputCount={setInputCountRoom}
                  />
                </div>
              </div>
            </>
          ...
          label: (
            <>
              <div className="flex items-center justify-between mb-3 py-0 px-4">
                ...
                <div>
                  <CountInput
                    inputCount={inputCountAdult}
                    setInputCount={setinputCountAdult}
                  />
                </div>
              </div>
            </>
          ...
          label: (
            <>
              <div className="flex items-center justify-between mb-3 py-0 px-4">
                ...
                <div>
                  <CountInput
                    inputCount={inputCountChildren}
                    setInputCount={setInputCountChildren}
                  />
                </div>
              </div>
            </>
        ...
        <div onClick={(e) => e.preventDefault()}>
          <Space>
            <div className="flex items-center gap-x-[10px]">
              ...
              <span className="font-normal text-sm text-ravi-black-100 font-primary line-clamp-1">
                {inputCountRoom} Phòng, {inputCountAdult} Người lớn
                {inputCountChildren > 0 && ",Trẻ em"}
              </span>
            </div>
            <span
              className={`${
